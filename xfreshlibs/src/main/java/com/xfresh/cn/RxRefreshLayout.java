...
import com.xfresh.cn.footer.BallPulseView;
import com.xfresh.cn.header.GoogleDotView;
import com.xfresh.cn.processor.AnimProcessor;
import com.xfresh.cn.processor.IDecorator;
import com.xfresh.cn.processor.OverScrollDecorator;
import com.xfresh.cn.processor.RefreshProcessor;
import com.xfresh.cn.util.DensityUtil;
import com.xfresh.cn.util.IBottomView;
import com.xfresh.cn.util.IHeaderView;
import com.xfresh.cn.util.OnAnimEndListener;
import com.xfresh.cn.util.OnGestureListener;
import com.xfresh.cn.util.PullListener;
...
public class RxRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public RxRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RXRefreshLayout, defStyleAttr, 0);
        try {
            mMaxHeadHeight = a.getDimensionPixelSize(R.styleable.RXRefreshLayout_tr_max_head_height, (int) DensityUtil.dp2px(context, 120));
            mHeadHeight = a.getDimensionPixelSize(R.styleable.RXRefreshLayout_tr_head_height, (int) DensityUtil.dp2px(context, 80));
            mMaxBottomHeight = a.getDimensionPixelSize(R.styleable.RXRefreshLayout_tr_max_bottom_height, (int) DensityUtil.dp2px(context, 120));
            mBottomHeight = a.getDimensionPixelSize(R.styleable.RXRefreshLayout_tr_bottom_height, (int) DensityUtil.dp2px(context, 60));
            mOverScrollHeight = a.getDimensionPixelSize(R.styleable.RXRefreshLayout_tr_overscroll_height, (int) mHeadHeight);
            enableRefresh = a.getBoolean(R.styleable.RXRefreshLayout_tr_enable_refresh, true);
            enableLoadmore = a.getBoolean(R.styleable.RXRefreshLayout_tr_enable_loadmore, true);
            isPureScrollModeOn = a.getBoolean(R.styleable.RXRefreshLayout_tr_pureScrollMode_on, false);
            isOverScrollTopShow = a.getBoolean(R.styleable.RXRefreshLayout_tr_overscroll_top_show, true);
            isOverScrollBottomShow = a.getBoolean(R.styleable.RXRefreshLayout_tr_overscroll_bottom_show, true);
            enableOverScroll = a.getBoolean(R.styleable.RXRefreshLayout_tr_enable_overscroll, true);
            floatRefresh = a.getBoolean(R.styleable.RXRefreshLayout_tr_floatRefresh, false);
            autoLoadMore = a.getBoolean(R.styleable.RXRefreshLayout_tr_autoLoadMore, false);
            enableKeepIView = a.getBoolean(R.styleable.RXRefreshLayout_tr_enable_keepIView, true);
            showRefreshingWhenOverScroll = a.getBoolean(R.styleable.RXRefreshLayout_tr_showRefreshingWhenOverScroll, true);
            showLoadingWhenOverScroll = a.getBoolean(R.styleable.RXRefreshLayout_tr_showLoadingWhenOverScroll, true);
        } finally {
            a.recycle();
        }
    ...
    public class CoContext {
        ...
        public void onPullingDown(float offsetY) {
            pullListener.onPullingDown(RxRefreshLayout.this, offsetY / mHeadHeight);
        }

        public void onPullingUp(float offsetY) {
            pullListener.onPullingUp(RxRefreshLayout.this, offsetY / mBottomHeight);
        }

        public void onRefresh() {
            pullListener.onRefresh(RxRefreshLayout.this);
        }

        public void onLoadMore() {
            pullListener.onLoadMore(RxRefreshLayout.this);
        }
        ...
        public void onPullDownReleasing(float offsetY) {
            pullListener.onPullDownReleasing(RxRefreshLayout.this, offsetY / mHeadHeight);
        }

        public void onPullUpReleasing(float offsetY) {
            pullListener.onPullUpReleasing(RxRefreshLayout.this, offsetY / mBottomHeight);
        }

        public boolean dispatchTouchEventSuper(MotionEvent ev) {
            return RxRefreshLayout.super.dispatchTouchEvent(ev);
        }
